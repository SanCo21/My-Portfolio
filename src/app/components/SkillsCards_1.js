...
// const InfiniteCarousel = ({ skills }) => {
  ...
  // const {skills } = content.sectionsData.skills;
  ...
  return (
    <div className="relative w-full">
      <div className="overflow-hidden py-12">
        <div className="hover-pause flex gap-8">
          <div className="flex gap-8 animate-infinite-scroll">
            {repeatedSkills.map((skill, index) => (
              <div 
                key={index}
                className="skill-item flex-shrink-0 bg-blue-900 p-4 rounded-lg"
              >
                {skill.name === "Tailwind" ? (
                  <svg className="filter-white w-20 h-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 33">
...
//     <div className="skills-content mt-10 mx-auto container relative overflow-hidden">
