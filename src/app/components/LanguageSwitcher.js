...
const LanguageSwitcher = ({ lang, toggleLanguage }) => {
  return (
    <button
      ...
      className="flex items-center justify-center p-2 text-primary bg-white rounded-2xl border-white border-2 hover:bg-accent hover:text-white transition-colors duration-300"
    >
